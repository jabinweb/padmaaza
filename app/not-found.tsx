      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        >
          <div className="relative mx-auto w-96 h-64 mb-8">
            ...
            >
              <div className="text-8xl font-bold bg-gradient-to-r from-emerald-600 to-blue-600 bg-clip-text text-transparent">
                404
              </div>
            </motion.div>
        ...
        >
          ...
          <div className="flex justify-center items-center space-x-2 text-sm text-slate-500 mb-8">
                  ...
                  <Link href={link.href}>
                    <Card className="h-full hover:shadow-xl transition-all duration-300 group border-0 shadow-lg cursor-pointer">
                      <CardContent className="p-6 text-center">
                        <div className="mb-4">
                          <div className={`inline-flex p-4 ${link.color} rounded-2xl shadow-lg group-hover:scale-110 transition-transform duration-300`}>
        ...
        <motion.div
          ...
          className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-2xl p-8 border border-emerald-100"
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button asChild variant="outline" className="border-emerald-200 hover:bg-emerald-50">
              <Link href="/contact">
